...
<img v-click class="absolute -bottom-9 -left-7 w-80 opacity-50"
...
Read more about [How to use a theme](https://sli.dev/themes/use.html) and check out
the [Awesome Themes Gallery](https://sli.dev/themes/gallery.html).
