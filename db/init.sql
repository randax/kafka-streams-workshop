...
(
    ...
    CONSTRAINT fk_book_author FOREIGN KEY (author_id) REFERENCES inventory.author (id)
);
...
ALTER TABLE inventory.author
    REPLICA IDENTITY FULL;

ALTER TABLE inventory.book
    REPLICA IDENTITY FULL;

INSERT INTO inventory.author
values (1, 'Bill Bryson');

INSERT INTO inventory.book
